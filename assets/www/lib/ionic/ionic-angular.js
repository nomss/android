...
function($provide) {
  function $LocationDecorator($location, $timeout) {
    ...
    // Mobile team fix - commenting out to allow Alert-List to persist previous scrolling state (Not Needed?)
    // http://forum.ionicframework.com/t/visible-scroll-jump-on-state-change/6184/3
      if (isDefined(value)) {
        $timeout(function() {
...
.controller('$ionicRefresher', [
  ...
  function($scope, $attrs, $element, $ionicBind, $timeout) {
    var self = this,
        ...
        deltaY = null,
        canOverscroll = true,
        isRunning = false, // Mobile team fix - Double ion-refresher executing https://github.com/driftyco/ionic/pull/3940
        scrollParent,
        scrollChild;
    ...
    function start() {
      ...
      // Mobile team fix - Double ion-refresher executing https://github.com/driftyco/ionic/pull/3940
      if (isRunning) {  
    	return;  
      }  
      isRunning = true;  
...
var WIDTH_HEIGHT_REGEX = /(height|width):.*?px;\s*(width|height):.*?px/;
...
function($timeout, $controller, $ionicBind, $ionicConfig) {
  return {
    ...
    compile: function(element, attr) {
	  ...
	  // Mobile team fix
      var nativeScrolling = attr.overflowScroll === "true" || !$ionicConfig.scrolling.jsScrolling() || (attr.overflowScroll == null && ionic.Platform.platform() == 'win32');
        ...
        function onTap(e) {
          ...
          if (ionic.DomUtil.rectContains(
            ...
            bounds.left + bounds.width, bounds.top + bounds.height
    	  	...
    	  	// Mobile team fix - "Cannot read property scrollto of null"
        	// http://stackoverflow.com/questions/29247556/ionic-scrolltop-cannot-read-property-scrollto-of-null-still-exists-in-1-0-0
            if (window.isCordova) {
